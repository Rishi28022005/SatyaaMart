...
export function OrderHistory() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      try {
        const rpcResult = await supabase.rpc("get_vendor_orders", {
        ...
        if (row.item_id) {
          ...
          order.order_items.push({
            ...
            products: {
              ...
              suppliers: {
                business_name: row.supplier_name || "Unknown Supplier",
              },
            },
          })
        }
                ...
                <div key={item.id} className="flex items-center justify-between py-2 border-b last:border-b-0">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">by {item.products.suppliers?.business_name}</p>
                    </div>
                  </div>
